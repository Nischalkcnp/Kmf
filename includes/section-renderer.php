...
function renderCustomSection($section) {
    ?>
    <section class="py-12 lg:py-20 bg-white relative overflow-hidden border-t border-slate-50">
        <div class="container mx-auto px-4 lg:px-8 relative z-10">
            <div class="flex flex-col lg:flex-row items-center gap-12 lg:gap-20 <?php echo $section['id'] % 2 === 0 ? 'lg:flex-row-reverse' : ''; ?>">
                <?php if (!empty($section['image_url'])): ?>
                    <div class="w-full lg:w-1/2">
                        <div class="relative rounded-[2.5rem] overflow-hidden shadow-2xl transition-transform hover:scale-[1.02] duration-500">
                ...
                <div class="w-full <?php echo !empty($section['image_url']) ? 'lg:w-1/2' : 'max-w-4xl mx-auto text-center'; ?>">
                    <?php if (!empty($section['subtitle'])): ?>
                        <span class="text-kmf-orange font-bold uppercase tracking-[0.2em] text-xs mb-4 block"><?php echo escape($section['subtitle']); ?></span>
                    <?php endif; ?>
                    <h2 class="text-3xl md:text-5xl font-extrabold text-kmf-blue font-montserrat tracking-tight mb-8"><?php echo escape($section['title']); ?></h2>
        ...
        <div class="container mx-auto px-4 lg:px-8 relative z-10 py-12 md:py-20">
            <div class="max-w-4xl">
                <div class="inline-flex items-center gap-3 px-6 py-2 bg-[#F5E6E0] rounded-full mb-8 transform hover:scale-105 transition-all cursor-default group">
                 ...
                 <h1 class="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-white mb-6 md:mb-8 leading-[1.1] tracking-tight drop-shadow-xl">
        ...
        <div class="container mx-auto px-4 lg:px-8 relative z-10">
            <div class="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
                ...
                <div class="w-full lg:w-7/12">
                    <div class="max-w-2xl text-lg text-slate-600 leading-relaxed font-medium space-y-6">
                        ...
                        <h2 class="text-4xl lg:text-5xl font-extrabold text-kmf-blue mb-8 font-montserrat tracking-tight leading-tight">Message From Our <br><span class="text-kmf-orange">President</span></h2>
                        <!-- Quote Icon -->
    ...
    <section class="py-12 lg:py-20 bg-white relative overflow-hidden">
        ...
        <div class="container mx-auto px-4 lg:px-8 relative z-10">
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-10 mb-24 md:mb-32">
                ...
                <div class="bg-gray-50/50 p-8 rounded-3xl border border-gray-100 text-center hover:bg-white hover:shadow-2xl transition-all duration-500 group">
                    <h3 class="text-4xl font-extrabold text-kmf-blue mb-2 font-montserrat tracking-tighter counter-stat" 
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
                <div class="p-10 lg:p-12 rounded-[2.5rem] border border-gray-100 shadow-sm bg-white h-full border-t-4 border-t-kmf-blue hover:shadow-xl transition-all duration-500">
                ...
                <div class="p-10 lg:p-12 rounded-[2.5rem] border border-gray-100 shadow-sm bg-white h-full border-t-4 border-t-kmf-orange hover:shadow-xl transition-all duration-500">
                ...
                <div class="p-10 lg:p-12 rounded-[2.5rem] border border-gray-100 shadow-sm bg-white h-full border-t-4 border-t-green-500 hover:shadow-xl transition-all duration-500">
...
function renderTeamGrid($team) {
    ...
    ?>
    <section class="py-12 lg:py-20 bg-gray-50/50">
        <div class="container mx-auto px-4 lg:px-8">
            <div class="flex items-end justify-between mb-16">
                ...
                <a href="<?php echo BASE_URL; ?>about.php" class="font-bold text-kmf-blue hover:text-kmf-orange transition-colors">View All &rarr;</a>
            </div>
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 lg:gap-8">
                <?php foreach ($team as $t): ?>
                <div class="bg-white rounded-[2rem] p-8 border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-300 group hover:-translate-y-2 text-center">
                    <div class="relative w-32 h-32 mx-auto mb-6 transition-transform duration-300 group-hover:scale-110">
                        <?php if (!empty($t['image_url'])): ?>
                            <img src="<?php echo BASE_URL . escape($t['image_url']); ?>" class="w-full h-full rounded-full object-cover border-4 border-white shadow-md">
                        <?php else: ?>
                            <div class="w-full h-full rounded-full bg-kmf-orange/10 flex items-center justify-center text-kmf-blue font-bold text-3xl border-4 border-white shadow-md"><?php echo strtoupper(substr($t['name'], 0, 1)); ?></div>
                        <?php endif; ?>
                    </div>
                    <h3 class="font-bold text-xl text-kmf-blue mb-1"><?php echo escape($t['name']); ?></h3>
                    <p class="text-kmf-orange font-semibold text-xs uppercase tracking-widest"><?php echo escape($t['role'] ?? ''); ?></p>
                </div>
                <?php endforeach; ?>
            </div>
        </div>
...
function renderStrategicAreas($areas) {
    ...
    <section class="py-12 lg:py-20 bg-white">
        <div class="container mx-auto px-4 lg:px-8">
            <h2 class="text-3xl md:text-5xl font-extrabold text-kmf-blue font-montserrat mb-16 tracking-tight leading-tight">Strategic Areas of Focus</h2>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <?php foreach ($areas as $a): 
                    $icon = strtolower($a['title']);
                ?>
                <div class="group bg-white rounded-[2.5rem] p-10 shadow-sm hover:shadow-2xl transition-all duration-500 border border-gray-100 relative overflow-hidden">
                    <div class="w-20 h-20 rounded-3xl bg-gray-50 flex items-center justify-center mb-8 group-hover:scale-110 transition-transform duration-500">
                        <?php if (str_contains($icon, 'education')): ?>
                            <svg class="w-10 h-10 text-kmf-blue" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M12 14l9-5-9-5-9 5 9 5z"/><path d="M12 14l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M22 10v6M2 10v6"/></svg>
                        <?php elseif (str_contains($icon, 'health')): ?>
                            <svg class="w-10 h-10 text-kmf-green" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"/></svg>
                        <?php else: ?>
                            <svg class="w-10 h-10 text-kmf-orange" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"/></svg>
                        <?php endif; ?>
                    </div>
                    <h3 class="text-2xl font-extrabold text-kmf-blue mb-5 tracking-tight"><?php echo escape($a['title']); ?></h3>
                    <p class="text-gray-500 leading-relaxed font-medium mb-10"><?php echo escape($a['excerpt']); ?></p>
                    <a href="<?php echo BASE_URL; ?>what-we-do.php#<?php echo escape($a['slug']); ?>" class="font-bold text-kmf-orange hover:text-kmf-blue transition-colors uppercase text-sm tracking-widest inline-flex items-center gap-2">Learn More <span>&rarr;</span></a>
                </div>
                <?php endforeach; ?>
            </div>
        </div>
...
function renderPublicationsList($publications) {
    ...
    ?>
    <section class="py-12 lg:py-20 bg-white border-t border-slate-50">
        <div class="container mx-auto px-4 lg:px-8">
            <div class="flex items-end justify-between mb-16">
                ...
                <a href="<?php echo BASE_URL; ?>resources.php" class="font-bold text-kmf-blue hover:text-kmf-orange transition-colors">View All &rarr;</a>
            </div>
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                <?php foreach ($publications as $pub): ?>
                <div class="group flex flex-col bg-white rounded-[2.5rem] overflow-hidden border border-gray-100 shadow-sm hover:shadow-2xl transition-all duration-500">
                    ...
                    <div class="p-8 flex flex-col flex-grow">
                        <span class="text-xs font-bold text-kmf-orange uppercase mb-3 block tracking-widest"><?php echo escape($pub['type'] ?? 'Publication'); ?></span>
                        ...
                        <p class="text-gray-500 text-sm font-medium mb-6 line-clamp-2"><?php echo escape($pub['excerpt']); ?></p>
                        <a href="<?php echo BASE_URL; ?>resources.php" class="text-kmf-blue font-bold text-sm tracking-widest uppercase mt-auto">Download &rarr;</a>
                    </div>
                </div>
                <?php endforeach; ?>
            </div>
        ...
        <div class="container mx-auto px-4 lg:px-8 relative z-10">
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24">
                <div class="lg:col-span-5">
                    <h2 class="text-3xl md:text-5xl font-extrabold text-kmf-blue font-montserrat mb-10 tracking-tight leading-tight">Upcoming Events</h2>
                    <?php if ($upcomingEvent): ?>
                        <div class="bg-slate-50 border border-slate-100 p-10 rounded-[2rem] hover:bg-white hover:shadow-2xl transition-all duration-500">
                            <div class="flex items-center gap-5 mb-8">
                                <div class="px-5 py-3 rounded-2xl bg-kmf-orange text-white text-center shadow-lg shadow-kmf-orange/20">
                                    <span class="block text-2xl font-black"><?php echo date('d', strtotime($upcomingEvent['event_date'])); ?></span>
                                    <span class="text-[10px] font-bold uppercase tracking-widest"><?php echo date('M', strtotime($upcomingEvent['event_date'])); ?></span>
                                </div>
                                <h3 class="text-2xl font-bold text-kmf-blue"><?php echo escape($upcomingEvent['title']); ?></h3>
                            </div>
                            <p class="text-slate-500 text-sm font-medium mb-8 inline-flex items-center gap-2">
                    ...
                    <?php else: ?>
                        <p class="text-slate-400 italic p-10 border border-dashed rounded-[2rem]">Stay tuned for upcoming events.</p>
                    <?php endif; ?>
                </div>
                <div class="lg:col-span-7">
                    <div class="flex items-end justify-between mb-10">
                        <h2 class="text-3xl md:text-5xl font-extrabold text-kmf-blue font-montserrat tracking-tight leading-tight">Latest News</h2>
                        <a href="<?php echo BASE_URL; ?>news.php" class="text-slate-400 font-bold hover:text-kmf-blue transition-colors">All Stories &rarr;</a>
                    </div>
                    <div class="space-y-6">
                        <?php foreach ($latestNews as $n): ?>
                        <a href="<?php echo BASE_URL; ?>news.php#news-<?php echo (int)$n['id']; ?>" class="group flex items-center gap-8 p-8 rounded-[2rem] bg-slate-50 hover:bg-white hover:shadow-xl border border-slate-100 transition-all duration-300">
                            <div class="flex-grow">
                            ...
                            <div class="w-12 h-12 rounded-full border border-slate-200 flex items-center justify-center group-hover:bg-kmf-orange group-hover:border-kmf-orange group-hover:text-white transition-all">
...
function renderPartnersMarquee($partners) {
    ...
    ?>
    <section class="py-10 md:py-16 bg-white border-t border-gray-50 overflow-hidden text-center">
        <div class="container mx-auto px-4 mb-12">
            <h2 class="text-2xl md:text-3xl font-extrabold text-kmf-blue font-montserrat tracking-tight">Trusted Partners</h2>
        </div>
        ...
        <div class="marquee-container">
            <div class="marquee-content flex items-center gap-16 md:gap-32 py-4">
                <?php 
                ...
                ?>
                    <div class="flex-shrink-0 grayscale hover:grayscale-0 opacity-50 hover:opacity-100 transition-all duration-500">
                        <?php if ($p['logo_url']): ?>
                            <img src="<?php echo BASE_URL . escape($p['logo_url']); ?>" alt="<?php echo escape($p['name']); ?>" class="h-10 md:h-14 w-auto object-contain">
                        <?php else: ?>
                            <span class="font-bold text-slate-400 text-lg"><?php echo escape($p['name']); ?></span>
                        <?php endif; ?>
                    </div>
                <?php endforeach; ?>
            </div>
