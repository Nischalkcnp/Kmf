...
<section class="relative py-10 lg:py-16 overflow-hidden bg-white">
    ...
    <div class="container mx-auto px-4 lg:px-8 relative z-10">
        <div class="max-w-4xl mx-auto text-center mb-10 lg:mb-12">
            ...
            <h1 class="text-3xl md:text-5xl font-black text-kmf-blue mb-4 tracking-tighter leading-tight">Your Support <span class="text-kmf-orange">Empowers</span> Rural Communities</h1>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 items-start">
            ...
            <div class="space-y-6">
                <div class="bg-gray-50/50 rounded-3xl p-6 lg:p-8 border border-gray-100">
                    ...
                    <p class="text-slate-500 mb-6 font-medium text-sm">You can donate directly to our official bank account. Please share the confirmation receipt with us at <a href="mailto:info@kmf.org.np" class="text-kmf-blue font-bold hover:text-kmf-orange transition-colors">info@kmf.org.np</a>.</p>
            ...
            <div class="lg:sticky lg:top-28 space-y-6">
                <div class="bg-white rounded-3xl p-6 lg:p-8 shadow-xl shadow-kmf-blue/5 border border-gray-50 flex flex-col items-center text-center">
                    ...
                    <div class="w-48 h-48 bg-gray-50 rounded-3xl border-4 border-dashed border-gray-200 flex items-center justify-center mb-6 p-4">
                        ...
                        <div class="text-center">
                            ...
                            <span class="text-[10px] font-bold text-gray-400 uppercase tracking-widest">QR Code Placeholder</span>
                        </div>
                    </div>

                    <div class="grid grid-cols-2 gap-4 w-full">
                        <div class="p-3 bg-gray-50 rounded-xl flex items-center justify-center grayscale hover:grayscale-0 transition-all opacity-60 hover:opacity-100">
                ...
                <div class="bg-kmf-orange/5 rounded-3xl p-6 lg:p-8 border border-kmf-orange/10">
                    ...
                    <p class="text-slate-600 font-medium text-xs mb-4">If you wish to donate materials, sponsor a child's education, or volunteer your skills, please get in touch with our team.</p>
